...
public class Messages {
	...
	public static final String ERREUR_NOM_JOUEUR = "[ERREUR] Le nom du joueur doit être inférieur ou égal à 8 caractères !";
	public static final String ERREUR_MODE_CARTES = "[ERREUR] Le mode doit être égal à 1, 2 ou 3 !";
